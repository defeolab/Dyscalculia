...
public class DragDropEasy : MonoBehaviour
{
    ...
    List<string> values = new List<string> { "symbolicWithAnimationEasy0_1", "symbolicWithAnimationEasy0_2", "symbolicWithAnimationEasy0_3", "symbolicWithAnimationEasy0_4","symbolicWitDiffSizeEasy"};
