...
def create_trial_from_array(array):
    ...
    # return Trial(area_1_number_of_chickens = array[0], area_2_number_of_chickens = array[1]
    #              , area_1_field_area = array[2], area_2_field_area = array[3]
    #              , area_1_item_surface_area = array[4], area_2_item_surface_area = array[5]
    #              , chicken_show_time = array[6], max_trial_time = array[7], flag_binaria = 0) 
