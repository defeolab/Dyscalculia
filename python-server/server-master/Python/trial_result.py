...
# C'è bisogno di scriverla di nuovo per adattarla a Trial_New? Secondo me, una volta che Trial_New si 
...
class TrialResult:
    ...
    def __init__(self, decision_time, correct, raw_trial_data=None, trial_data=None):
        ...
        if raw_trial_data != None:
            ...
            self.trial_data = Trial_New(area_1_data = area_1_data
                                        , area_2_data = area_2_data
            ...
            #                         , ratio=raw_trial_data["ratio"]
            #                         , chicken_show_time=raw_trial_data["chickenShowTime"]
            #                         , max_trial_time=raw_trial_data["maxTrialTime"]
            #                         , ratio_area=raw_trial_data["ratioArea"])
