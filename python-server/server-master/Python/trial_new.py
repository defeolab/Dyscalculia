...
import json
# import numpy as np --> serve casomai SOLO per la funzione to_array
from area_data import AreaData

class Trial_New:
    def __init__(self, area_1_data=None, area_2_data=None, area_1_circle_radius=None, area_2_circle_radius=None,
                 area_1_size_of_chicken=None, area_2_size_of_chicken=None, area_1_average_space_between=None, 
                 area_2_average_space_between=None, area_1_number_of_chickens=None, area_2_number_of_chickens=None, 
